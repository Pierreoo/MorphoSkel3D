...
def normalize_data(batch_data):
    """ Normalize the batch dataloaders, use coordinates of the block centered at origin,
        Input:
            BxNxC array
        Output:
            BxNxC array
...
def shuffle_data(data, labels):
    """ Shuffle dataloaders and labels.
        Input:
          dataloaders: B,N,... numpy array
          label: B,... numpy array
        Return:
          shuffled dataloaders, label and shuffle indices
    """
...
def index_points(points, idx):
    """
    Input:
        points: input points dataloaders, [B, N, C]
        idx: sample index dataloaders, [B, S]
    Return:
        new_points:, indexed points dataloaders, [B, S, C]
    """
...
def farthest_point_sample(xyz, npoint):
    """
    Input:
        xyz: pointcloud dataloaders, [B, N, 3]
